                    ...
                    <ul>
                        ...
                        <li class="last">
                            ...
                            <label>
                                ...
                                记住我							</label>
                            <a href="/doc.php/web/user/find_password/">&nbsp;&nbsp;忘记密码</a>
                        </li>
                    </ul>
                </form>
            </div>
            <div>
                <?php include DOC_PATH . 'views/doc/web/user/ding/ding_admin_login.php' ?>
            </div>

        </div>
        <div class="mod-footer">
            <span>还没有账号?</span>&nbsp;&nbsp;
            <a href="/doc.php/web/user/register">立即注册</a>&nbsp;&nbsp;•&nbsp;&nbsp;
        </div>
    </div>
</div>
</body>
            ...
            success: function (data) {
                ...
                if (data.status == 0) {
                    layer.alert(data.msg, {icon: 1}, function () {
                        window.location.href = '/doc.php/web/file/index';
                    });
                } else {
