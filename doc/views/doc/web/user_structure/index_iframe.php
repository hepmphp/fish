...
<div class="wrapper">
    <div class="navtop clearfix">
        <h1 class="nav-title">人物关系树形结构<b></b></h1>
        ...
        <div class="nav-right">
            ...
            <span class="user-con">
		<a href="#" class="a1" onclick="#"  id="username">菜单</a>
    ...
    <div class="Business-back">
        <div class="Business-left left_0 transition clearfix">
            ...
            <ul class="list-unstyled left-Catalog" id="boxscroll">
                    <li class="nav-toggle"><span class="nav-open"><i class="fa fa-bar-chart" aria-hidden="true">树形结构管理</i></span>
                    <ul class="list-unstyled leftnav-view">
                        <li><a class="J_menuItem" href="/doc.php/web/user_structure/index">树形结构列表</a></li>
                        <li><a class="J_menuItem" href="/doc.php/web/tree_node/index">树形结构分类</a></li>
                    </ul>
                    </li>
            </ul>
        </div>
