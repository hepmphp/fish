...
function uploadImg(){
    $(".upload-img-mutil input").change(function() {
        ...
        var str = '<div class="upload-img  upload-img-mutil left"><span class="image-item"></span><img src="http://127.0.0.1/static/admin/images/upload_image.png" alt=""><input type="file" name="images" style="opacity:0" accept="image/*" capture="camera"/><i class="iconfont icon-lajitong"></i><i class="iconfont icon-tianjia"></i><div class="over-cover"></div></div>';
        $.ajax({
            type: 'POST',
            url: upload_api,
            data: formdata,
