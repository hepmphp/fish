...
(function () {
    ...
    if(window.location.host.indexOf('local')!=-1){
        var PHP_URL = 'http://127.0.0.1:3333/?r=api/upload-umeditor/index';
        var STATIC_URL = 'http://127.0.0.1:3333/';
    }else{
        var PHP_URL = 'http://127.0.0.1:3333/?r=api/upload-umeditor/index';
        var STATIC_URL = 'http://127.0.0.1:3333//';
    }
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:PHP_URL             //图片上传提交地址
        ,imagePath:STATIC_URL                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
