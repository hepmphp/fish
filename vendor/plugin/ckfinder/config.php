...
$config['licenseName'] = '*';
$config['licenseKey']  = '*K?M-*1**-V**Y-*V**-*5**-1*P*-2**L';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => SITE_URL.'ckfinder/',
    'root'         => WEB_PATH.'/ckfinder/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
