...
class Bug extends Model
{
    ...
    public function get_list_info($where = array(), $limit = 1, $offset = 20, $fields = '*')
    {
        ...
        foreach ($data as $k=>$v){
            ...
            $data[$k]['bug_level'] = $this->get_config_bug_level()[$v['bug_level']]['text'];
...
//        7 海蓝 #70DB93
    ...
    static function get_config_bug_level(){
        return [
            1=>['id'=>1,'name'=>'1级','text'=>'<image src="'.STATIC_URL.'images/bug/bug_1.png">1级</image>'],
            2=>['id'=>2,'name'=>'2级','text'=>'<image src="'.STATIC_URL.'images/bug/bug_2.png">2级</image>'],
            3=>['id'=>3,'name'=>'3级','text'=>'<image src="'.STATIC_URL.'images/bug/bug_3.png">3级</image>'],
            4=>['id'=>4,'name'=>'4级','text'=>'<image src="'.STATIC_URL.'images/bug/bug_4.png">4级</image>'],
            5=>['id'=>5,'name'=>'5级','text'=>'<image src="'.STATIC_URL.'images/bug/bug_5.png">5级</image>'],
            6=>['id'=>6,'name'=>'6级','text'=>'<image src="'.STATIC_URL.'images/bug/bug_6.png">6级</image>'],
            7=>['id'=>7,'name'=>'7级','text'=>'<image src="'.STATIC_URL.'images/bug/bug_6.png">7级</image>'],
        ];
    }
...
##生成时间:2024-11-22 11:01:54 文件路径：Bug.php🐘