...
<script>
    ...
    function ajax_list(param) {
        ...
        var list_html = '';
        $.getJSON('/api/im/group/get_list/?' + $.param(param), function (data) {
            layer.closeAll();
            if (data.status == 0) {
    ...
    var urls = {
        create_url:'/api/im/group/create',
        update_url:'/api/im/group/update',
        delete_url:'/api/im/group/delete',
        info_url:'/api/im/group/info'
    };
