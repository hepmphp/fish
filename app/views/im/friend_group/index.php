...
<div class="form-wrapper">
    <div class="form-item">
        ...
        <div class="form-group">
            <label class="control-label">好友分组排序 越小越前：</label>
            <input placeholder="文本" class="form-control" name="weight" id="weight" value="<?=$form['weight']?>" type="text">
        </div>
        <div class="form-group">
...
<script>
    ...
    function ajax_list(param) {
        ...
        var list_html = '';
        $.getJSON('/api/im/friend_group/get_list/?' + $.param(param), function (data) {
            layer.closeAll();
            if (data.status == 0) {
...
var urls = {
    create_url:'/api/im/friend_group/create',
    update_url:'/api/im/friend_group/update',
    delete_url:'/api/im/friend_group/delete',
    info_url:'/api/im/friend_group/info'
};
 ...
 */
function add(){
    var url = '/im/friend_group/create';
 ...
 */
function edit(id) {
    var url = "/im/friend_group/update?id="+id;
