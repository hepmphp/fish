...
<form action="" method="get" enctype="multipart/form-data" id="form" style="margin: 0 auto;width: 900px;">
<textarea name="sql" style="width: 900px;height: 400px;border: 1px solid blue;"></textarea>
    <br/>
    <div style="margin: 0 auto;">
        <button type="submit" name="" >查询sql</button>
    </div>
</form>
...
if(!empty($sql)){
    ...
    $res = $GLOBALS['db']->query($sql)->fetchAll(PDO::FETCH_ASSOC);
    echo "<pre>";
    echo "<div style='width:900px;height:600px;margin: 0 auto;'>";
