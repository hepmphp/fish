...
defined('FM_SELF_URL') || define('FM_SELF_URL',STATIC_URL.'images/file.png');
...
function fm_show_nav_path($path)
{
    ...
    <div class="path">
        ...
        <?php
        $path = fm_clean_path($path);
        $root_url = "<a href='?p='><i class='icon-home' title='" . FM_ROOT_PATH . "'></i> </a>".'<a href="#" id="git"><i class="icon-folder"></i>git管理</a>';
...
function fm_show_header()
{
    ...
    <head>
        ...
        <style>
            ...
            #wrapper{width:100%;min-width:400px;margin:10px auto;font-size: 16px;background-color: #FFFFFF!important;}
