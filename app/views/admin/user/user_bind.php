...
<div class="form-wrapper" style="padding-top: 0">
    <ul class="list-inline page-tab clearfix">
        ...
        <li class="cur"><a href="/admin/user/user_bind?iframe=1">用户信息绑定</a><em></em></li>
    </ul>
    <div class="form-item">
        <div class="form-main">
            ...
            <div class="row">
                <div class="col" style="float: left">
                    <div class="form-inline" style="width: 260px;">
                        <img src="<?=STATIC_URL?>images/ding_ding.png" width="40px" height="40px">
                    ...
                    <div class="form-inline" style="width: 260px;">
                        ...
                        <button type="button" class="btn btn-info " onclick="bind_email(<?=$form['ids']?>)" style="background-color: #0071ce;margin-left: 10px;margin-top: 8px;margin-left: 5px;">邮箱绑定登录</button>
                    </div>
