...
class Image {
    ...
    function __construct() {
    	$this->thumb_enable = true;
        $this->w_img = 'watermark.png';
        $this->w_pos = 9;
        $this->w_minwidth = 300;
        $this->w_minheight = 300;
        $this->w_quality = 80;
        $this->w_pct = 100;
	...
	function watermark($source, $target = '', $w_pos = '', $w_img = '', $w_text = 'ok_fish',$w_font = 8, $w_color = '#ff0000') {
		$w_pos = $w_pos ? $w_pos : $this->w_pos;
		$w_img = $w_img ? $w_img : $this->w_img;
		if(!$target) $target = $source;
		$w_img = WEB_PATH.'/static/admin/images/'.$w_img;
