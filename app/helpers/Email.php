...
Class Email
{
    private $server = 'smtp.139.com';
    private $port   =  25;
    private $secure = false;
    private $username = '15060779893@139.com';
    private $password = '84874f770303ac0a7400';
    public $to       = array();
    public $from     = array();
    public $cc       = array();
    public $bcc      = array();
    ...
    private $ahead;
    private $sock;
    private $hostname='smtp.139.com';
    private $local='mail.139.com';
    private $log      = array();
