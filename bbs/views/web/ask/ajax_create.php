                            ...
                            <div class="aw-mod aw-mod-publish">
                                <div class="mod-body">
                                    ...
                                    <div class="aw-publish-title">
                                        <div>
                                            <input type="text" placeholder="问题标题..." name="subject" id="subject" value="<?=$form['subject']?>" class="form-control">
                                        </div>
                                    </div>
                                    <!-- end 问题标题 -->
                                    <h3>分类:</h3>
                                    ...
                                    <div name="content" id="content"   type="text/plain" style="width:700px;height:500px;"></div>
