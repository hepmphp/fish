...
<div class="aw-register-box">
    ...
    <div class="mod-body">
        <form class="aw-register-form" id="fpw_form" method="post" action="http://127.0.0.1:2222/bbs.php/web/user/reset_password">
            <ul>
                ...
                <li class="aw-register-verify">
                    <img class="auth-img pull-right" id="captcha"  src="/bbs.php/web/captcha/get">
